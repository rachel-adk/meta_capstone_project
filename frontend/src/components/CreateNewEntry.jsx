...
const CreateNewEntry = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        return (
            ...
            className='bg-teal-700 text-white py-2 px-4 rounded hover:bg-teal-600'> + Add a New Entry
            </button>
            {showModal && (
                <div className='fixed inset-0 flex items-center justify-center bg-opacity-50 z-50'>
                    <div className='bg-white p-4 rounded-lg shadow-lg w-full max-w-md'>
                        <h2 className='text-xl font-bold font-semibold text-center text-teal-700 mb-4'>Create New Entry</h2>
