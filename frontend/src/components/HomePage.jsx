...
const HomePage = () => {
  return (
    ...
    <div className="h-screen flex justify-center items-center bg-cyan-50 ">
      <h1 className="text-2xl absolute -mt-200 text-teal-900">Take control of your health journey with us! </h1>
      <h1 className="text-2xl text-center absolute -mt-180 text-teal-900">Track symptoms, manage medical history, and keep all your health information organized in one secure place.  </h1>
